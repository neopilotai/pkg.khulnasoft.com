...
<template>
  <div class="flex flex-col gap-6">
    <GettingStartedStep step="1">
      First, install the GitHub application on your repositories.

      <template #actions>
        <UButton
          href="https://github.com/apps/pkg-khulnasoft"
          target="_blank"
          icon="mdi-github"
    ...
    <GettingStartedStep step="2">
      ...
      <template #actions>
        <UButton
          href="https://github.com/khulnasoft/pkg.khulnasoft.com?tab=readme-ov-file#examples"
          target="_blank"
          icon="ph-code-block"
          trailing-icon="ph-arrow-square-out"
        >
        ...
        <UButton
          href="https://github.com/khulnasoft/pkg.khulnasoft.com?tab=readme-ov-file#setup"
          target="_blank"
          icon="ph-notebook"
          trailing-icon="ph-arrow-square-out"
        >
          Learn more about pkg.khulnasoft.com setup
        </UButton>
      </template>
    </GettingStartedStep>
    ...
    <GettingStartedStep step="4">
      ...
      <div class="w-[550px]">
        <CodeSnippet
          class="text-[10px]"
          code="[![pkg.khulnasoft.com](https://pkg.khulnasoft.com/badge/OWNER/REPO)](https://pkg.khulnasoft.com/~/OWNER/REPO)"
        />
      </div>
      ...
      <template #actions>
        <UButton
          href="https://github.com/khulnasoft/pkg.khulnasoft.com?tab=readme-ov-file#badge"
          target="_blank"
          icon="ph-badge"
          trailing-icon="ph-arrow-square-out"
        >

import { isWhitelisted } from "@pkg-khulnasoft/utils";
...
export default eventHandler(async (event) => {
  ...
  if (!whitelisted) {
    ...
    throw createError({
      statusCode: 413,
      message:
        "Multipart uploads are only accessible to those who are in the whitelist! Feel free to apply for the whitelist: https://github.com/khulnasoft/pkg.khulnasoft.com/blob/main/.whitelist",
    });
  }

...
import type { Comment, PackageManager } from "@pkg-khulnasoft/utils";
import type { WorkflowData } from "../types";
import { isPullRequest, isWhitelisted } from "@pkg-khulnasoft/utils";
  ...
  try {
    ...
    if (!(await workflowsBucket.hasItem(key))) {
      throw createError({
        statusCode: 401,
        message:
          "Try publishing from a github workflow! Also make sure you install https://github.com/apps/pkg-khulnasoft GitHub app on the repo",
      });
    }
